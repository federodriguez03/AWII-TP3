    ...
    return function render(locals, callback) {
        ...
        fs_1.default.readFile(template, 'utf8', function (err, str) {
            ...
            const body = str
                ...
                .replace(/\{files\}/g, createHtmlFileList(locals.fileList, locals.baseURL + locals.directory, locals.displayIcons, locals.viewName))
                ...
                .replace(/\{base-url\}/g, (0, escape_html_1.default)(locals.baseURL));
            callback(null, body);
        });
    };
}
...
function htmlPath(dir, baseURL) {
    ...
    for (let i = 0; i < parts.length; i++) {
        ...
        if (part) {
            ...
            crumb[i] = '<a href="' + (0, escape_html_1.default)(baseURL + parts.slice(0, i + 1).join('/')) + '">' + (0, escape_html_1.default)(part) + '</a>';
        }
    }
    return crumb.join(' / ');
}
